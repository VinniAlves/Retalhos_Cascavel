...
const caminhoImg = "/home/ubuntu/Image/"
...
exports.postPecas = (req,res,next)=>{
    ...
    mysql.getConnection((error,conn)=>{
        ...
        conn.query(
           ...
           "INSERT INTO pecas (NomePeca,CodigoPeca,Tipo,Marca,MercadoURL,ImagemNomeI,ImagemNomeII,ImagemNomeIII,"
    ...
    mysql.getConnection((error, conn)=>{
        if(error){return res.status(500).send({error:error})}
            ...
            conn.query(
                 ...
                 "UPDATE pecas SET NomePeca=?, CodigoPeca=?, Tipo=?, Marca=?,"+
